        ...
        headers: [
          ...
          },
          {
            ...
            value: "default-src 'self' data: blob:; " +
                   ...
                   "worker-src 'self' blob: data: https://*.spline.design https://cdn.spline.design https://prod.spline.design https://www.gstatic.com https://*.gstatic.com https://unpkg.com https://*.unpkg.com; " +
